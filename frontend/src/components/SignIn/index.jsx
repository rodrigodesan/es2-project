  ...
  return (
    <div>
      ...
      <div className="ms-1">
        ...
        <input type="text" className="selection-bg text-center rounded-4 border border-dark mt-5 py-1 me-5" placeholder="email@example.com" aria-label="Login" aria-describedby="basic-addon1" value={email} onChange={(e) => setEmail(e.target.value)} />
      </div>
      <div className="mt-5">
        <span className="m-2 signUp-font" id="basic-addon2">Senha:</span>
        <div className="input-with-icon">
          <input type={senhaVisivel ? 'text' : 'password'} className="text-center selection-bg rounded-4 border border-dark py-1 me-5" placeholder="********" aria-label="Recipient's username" aria-describedby="basic-addon2" value={password} onChange={(e) => setPassword(e.target.value)} />
