      ...
      <div className="row mx-0">
        <div className="col-md-4 p-0">
          ...
          <div className="d-flex ps-md-5">
            <Button title="Buscar" icon="/src/assets/icons/search-icon.png" color="bg-search btn-md border border-dark" onClick={onFetchData} />
            <Button title="Limpar" icon="/src/assets/icons/clear-icon.png" color="bg-clear btn-md border border-dark" onClick={cleanSearch} />
          </div>
        </div>
        <div className="col-md-4 p-0">
